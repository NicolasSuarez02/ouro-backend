...
public class TimeSlotController {
    ...
    /**
     * Devuelve los slots FREE próximos de un terapeuta (desde ahora + 60 días).
     * Solo puede consultarlos el propio terapeuta.
     * GET /api/timeslots/therapist/{therapistId}?userId={userId}
     */
    @GetMapping("/therapist/{therapistId}")
    public ResponseEntity<Object> getUpcomingSlots(
    ...
    /**
     * Cancela (elimina) un slot FREE. Solo puede hacerlo el terapeuta dueño.
     * DELETE /api/timeslots/{slotId}?userId={userId}
     */
    @DeleteMapping("/{slotId}")
    public ResponseEntity<Object> deleteSlot(
